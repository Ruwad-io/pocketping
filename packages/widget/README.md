...
```bash
npm install @ruwad/pocketping-widget
```

```javascript
import { init } from '@ruwad/pocketping-widget';
...
```typescript
import { init, PocketPingConfig, Message } from '@ruwad/pocketping-widget';
